...
export class MselService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public archive(id: string, observe?: 'body', reportProgress?: boolean): Observable<Msel>;
    public archive(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Msel>>;
    public archive(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Msel>>;
    public archive(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    /**
     * Pull Integrations
     * Pulls all Integrations from the associated applications  &lt;para /&gt;  Accessible only to a ContentDeveloper or an Administrator
     * @param id The id of the MSEL
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public pullIntegrations(id: string, observe?: 'body', reportProgress?: boolean): Observable<Msel>;
    public pullIntegrations(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Msel>>;
    public pullIntegrations(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Msel>>;
    public pullIntegrations(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public pushIntegrations(id: string, observe?: 'body', reportProgress?: boolean): Observable<Msel>;
    public pushIntegrations(id: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Msel>>;
    public pushIntegrations(id: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Msel>>;
    public pushIntegrations(id: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling pushIntegrations.');
        }
