...
export class MselService {
     ...
     */
    public addTeamToMsel(mselId: string, teamId: string, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public addTeamToMsel(mselId: string, teamId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public addTeamToMsel(mselId: string, teamId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public addTeamToMsel(mselId: string, teamId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<string>(`${this.configuration.basePath}/api/msels/${encodeURIComponent(String(mselId))}/addteam/${encodeURIComponent(String(teamId))}`,
            null,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public removeTeamFromMsel(mselId: string, teamId: string, observe?: 'body', reportProgress?: boolean): Observable<boolean>;
    public removeTeamFromMsel(mselId: string, teamId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<boolean>>;
    public removeTeamFromMsel(mselId: string, teamId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<boolean>>;
    public removeTeamFromMsel(mselId: string, teamId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<boolean>(`${this.configuration.basePath}/api/msels/${encodeURIComponent(String(mselId))}/removeteam/${encodeURIComponent(String(teamId))}`,
            null,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
