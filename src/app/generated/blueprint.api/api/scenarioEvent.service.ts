...
export class ScenarioEventService {
     ...
     * Assigns the specified Team to the specified ScenarioEvent  &lt;para /&gt;  Accessible only to a Content Developer or a MSEL owner
     * @param scenarioEventId The ID of the ScenarioEvent
     * @param teamId The ID of the Team
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public assignTeamToScenarioEvent(scenarioEventId: string, teamId: string, observe?: 'body', reportProgress?: boolean): Observable<string>;
    public assignTeamToScenarioEvent(scenarioEventId: string, teamId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<string>>;
    public assignTeamToScenarioEvent(scenarioEventId: string, teamId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<string>>;
    public assignTeamToScenarioEvent(scenarioEventId: string, teamId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (scenarioEventId === null || scenarioEventId === undefined) {
            throw new Error('Required parameter scenarioEventId was null or undefined when calling assignTeamToScenarioEvent.');
        }
        if (teamId === null || teamId === undefined) {
            throw new Error('Required parameter teamId was null or undefined when calling assignTeamToScenarioEvent.');
        }
        ...
        return this.httpClient.put<string>(`${this.configuration.basePath}/api/scenarioevents/${encodeURIComponent(String(scenarioEventId))}/assignteam/${encodeURIComponent(String(teamId))}`,
            null,
            {
     ...
     * Unassigns the specified Team from the specified ScenarioEvent  &lt;para /&gt;  Accessible only to a Content Developer or a MSEL owner
     * @param scenarioEventId The ID of the ScenarioEvent
     * @param teamId The ID of the Team
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public unassignTeamToScenarioEvent(scenarioEventId: string, teamId: string, observe?: 'body', reportProgress?: boolean): Observable<boolean>;
    public unassignTeamToScenarioEvent(scenarioEventId: string, teamId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<boolean>>;
    public unassignTeamToScenarioEvent(scenarioEventId: string, teamId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<boolean>>;
    public unassignTeamToScenarioEvent(scenarioEventId: string, teamId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (scenarioEventId === null || scenarioEventId === undefined) {
            throw new Error('Required parameter scenarioEventId was null or undefined when calling unassignTeamToScenarioEvent.');
        }
        if (teamId === null || teamId === undefined) {
            throw new Error('Required parameter teamId was null or undefined when calling unassignTeamToScenarioEvent.');
        }
        ...
        return this.httpClient.put<boolean>(`${this.configuration.basePath}/api/scenarioevents/${encodeURIComponent(String(scenarioEventId))}/unassignteam/${encodeURIComponent(String(teamId))}`,
            null,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
