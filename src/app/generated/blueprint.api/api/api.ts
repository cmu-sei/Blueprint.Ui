...
export const APIS = [CardService, CardTeamService, CiteActionService, CiteRoleService, DataFieldService, DataOptionService, DataValueService, HealthCheckService, MoveService, MselService, OrganizationService, PermissionService, PlayerService, ScenarioEventService, TeamService, TeamUserService, UserService, UserMselRoleService, UserPermissionService];
