...
export class TeamUserService {
    ...
    /**
     * Gets all TeamUsers for the msel
     * Returns a list of all of the TeamUsers for the msel.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getMselTeamUsers(mselId: string, observe?: 'body', reportProgress?: boolean): Observable<Array<TeamUser>>;
    public getMselTeamUsers(mselId: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<TeamUser>>>;
    public getMselTeamUsers(mselId: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<TeamUser>>>;
    public getMselTeamUsers(mselId: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
