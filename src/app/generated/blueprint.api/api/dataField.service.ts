...
export class DataFieldService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDataFieldTemplates(observe?: 'body', reportProgress?: boolean): Observable<Array<DataField>>;
    public getDataFieldTemplates(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<DataField>>>;
    public getDataFieldTemplates(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<DataField>>>;
    public getDataFieldTemplates(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
