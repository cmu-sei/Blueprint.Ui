...
export type DataFieldType = 'String' | 'Integer' | 'Double' | 'Boolean' | 'DateTime' | 'Organization' | 'Html' | 'Card' | 'SourceType' | 'Team' | 'TeamsMultiple' | 'Status' | 'User' | 'Checkbox' | 'Url' | 'Move' | 'IntegrationTarget';
...
export const DataFieldType = {
    ...
    IntegrationTarget: 'IntegrationTarget' as DataFieldType
};
